=== WordPress Post FCM ===
Contributors: emil90
Donate link: https://github.com/EmilMfornyam/
Tags: FCM, emil90, Firebase, Notifications
...
Send notification to users in a topic or send single notification to specific user using token
...
1. Admin Bar FCM options (running with WordPress 3.3 here)
2. Admin Bar Send Single Notifications  (running with WordPress 3.3 here)

 == Upgrade Notice ==

Fixed FCM Icon size, Minor code tweaks, Fixed some ugly typos (Mmh, happens sometimes...)
